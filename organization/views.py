...
# from django.core.paginator import Paginator,EmptyPage,PageNotAnInteger  这个是django自带的，但是没有上面的好用
...
class OrgHomeView(View):
    ...
    def get(self, request, org_id):
        ...
        course_org.save()
        has_fav = False
        if request.user.is_authenticated:  # if request.user.is_authenticated():  2.0以前
